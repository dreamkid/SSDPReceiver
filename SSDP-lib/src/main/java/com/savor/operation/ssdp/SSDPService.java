...
//    private static final String IP_TARGET = "238.255.255.250";
    ...
    private void startReceive() {
        ...
        try {
            mSocketReceive = new MulticastSocket(Integer.valueOf(port));
            mSocketReceive.setLoopbackMode(true);
            mSocketReceive.setTimeToLive(0);
//            mSocketReceive.setSoTimeout(1000*12);
            mSocketReceive.joinGroup(InetAddress.getByName(address));
            ...
            do {
                ...
                if(mListener!=null) {
                    mListener.onSSDPReceived(msgReceived);
                }
    ...
    public interface OnSSDPReceivedListener {
        ...
        void onSSDPReceived(String message);
        void onBind(String address,String port);
        void onClose();
    }
